...
The main idea comes from xtrlock, but that package only works for x11. As I am on GNOME Mutter (Wayland), I decided to develop an extension for the GNOME Shell that can achieve the same thing (and more, hopefully).
